function [ra,ve,rdi] = sledgeFast2(rx,tx,p)
% needs windowing 
...
nB = 1000; % number of batches, can't be less than number of doppler bins
% optimally this is an integer number of doppler bins and power of 2
Nb = n/nB; % length of batches



% for 2d fft, nRan*nDop*2 < n there is no gaurunee this is true


ref = conj(tx);

sr = reshape(rx,[Nb,nB]);
% sref = reshape(tx,[Nb,nB]);
